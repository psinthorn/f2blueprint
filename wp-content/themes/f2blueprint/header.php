   ...
   <header class="site-header">
      <div class="container">
        <h1 class="school-logo-text float-left">
          <a href="<?php echo site_url(); ?>"><strong>F2</strong>Blueprint</a>
        </h1>
        ...
        <div class="site-header__menu group">
          ...
          <ul>
              ...
              <li <?php if (get_post_type() == 'type') echo 'class="current-menu-item"' ?>><a href="<?php echo get_post_type_archive_link('type'); ?>">Competion Type(s)</a></li>
