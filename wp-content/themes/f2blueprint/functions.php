...
// Page and post banner auto selection 
    ...
    function f2_blueprint_files() {
        ...
        if (strstr($_SERVER['SERVER_NAME'], 'f2blueprint.local')) {
            ...
            wp_enqueue_script('primary-main-js', get_theme_file_uri('/bundled-assets/scripts.17900f7e9b3a86b999f2.js'), NULL,'1.0', true );
            wp_enqueue_style('main_styles', get_stylesheet_uri('/bundled-assets/styles.17900f7e9b3a86b999f2.css'));
        }
